...
function JupyterLogo() {
  return <img src="img/Jupyter.svg" width="197px" height="234px" />;
}

function XTensorLogo() {
  return <img src="img/xtensor.png" width="257px" height="257px" />;
}

function CondaForgeLogo() {
  return <img src="img/conda_forge.svg" width="196px" height="180px" />;
}

function RoboticsLogo() {
  return <img src="img/robostack.png" width="189px" height="210px" />;
}
