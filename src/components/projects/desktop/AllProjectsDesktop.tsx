...
const ProjectsDescriptions = [JupyterDescription, CondaForgeDescription, XTensorXSIMDDescription, RoboticsDescription]
        ...
        <ul className={"row" + " " + styles.row_custom}>
              {projectsDetails.map((project, index) => (
                <li className="cards_list" key={index}>
                  <div className="col">
                    <ProjectDesktop project={project} ProjectDescriptionMD={ProjectsDescriptions[index]}/>
                  </div>
                </li>
              ))}
            </ul>
